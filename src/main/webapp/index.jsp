...
<link rel="stylesheet"
	...
	<jsp:attribute name="script">
		...
		<script
			src="https://cdn.datatables.net/v/bs4-4.1.1/dt-1.10.24/r-2.2.7/datatables.min.js"></script>
			<%@ include file="partials/scriptIndex.jsp"%>
			<%@ include file="partials/scriptTelefone.jsp"%>
	</jsp:attribute>
	...
	<div class="d-flex justify-content-between align-items-center">
		...
		<div>
			<a class="mb-0" href="login?action=logout">Sair</a>
		</div>
	</div>
	<table id="tabela"
